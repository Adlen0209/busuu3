...
(
    ...
    "liste_exercices" VARCHAR NOT NULL
);
...
(
    "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "numero_level" integer NOT NULL,
    "nombre_serie" integer NOT NULL,
    "numero_serie" integer NOT NULL,
    "objectif_id" integer NOT NULL REFERENCES "objectif" ("id")
);
...
(
    ...
    PRIMARY KEY ("niveau_id", "exercice_id")
);
